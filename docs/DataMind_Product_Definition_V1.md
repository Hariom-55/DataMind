...
**Version 1 ends at Machine Learning.**

Deep Learning, Generative AI, Agentic AI, automated model deployment, and advanced MLOps are outside the Version 1 product boundary.
